...
Top-down (layout):
![B top-down](renders/B_top.png)

3/4 view:
![B 3/4](renders/B_tray.png)
...
Top-down (layout):
![C top-down](renders/C_top.png)

3/4 view (stepped honeycomb):
![C 3/4](renders/C_tray.png)

Cutaway — vials rest on the base, each in its own cell (red = reference vials):
![C cutaway](renders/C_section.png)

Lid (prints roof-down):
![C lid](renders/C_lid.png)
